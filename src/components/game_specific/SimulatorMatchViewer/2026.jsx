                ...
                <div className="alliance-match-result red">
                    ...
                    <div className="rp-scores-row">
                        ...
                        <div className="scores">
                            ...
                            <div className="row"><div className="label">TOWER</div><div className="score">{match.red.endgameScore}</div></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="alliance-match-result blue">
                    ...
                    <div className="rp-scores-row">
                        <div className="scores">
                            ...
                            <div className="row"><div className="score">{match.blue.endgameScore}</div><div className="label">TOWER</div></div>
                        </div>
                        <div className="rps">
