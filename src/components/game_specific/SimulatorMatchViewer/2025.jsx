...
export default function SimulatorMatchViewer_Universal({sim}) {
    ...
    return <>
        <div className="match-navigator-bar">
            <a onClick={() => displayMatch(-1, sim)}>Statistical Average</a>
            ...
            <div className="column">
                <div className="alliance-match-result red">
                    ...
                    <div className="rp-scores-row">
                        <div className="rps">
                            <div className="total-rp">{match.red.matchRP + match.red.gameStats.autoRP + match.red.gameStats.coralRP + match.red.gameStats.bargeRP} RP</div>
                            <div className={"rp-cell" + (match.red.gameStats.autoRP ? " win" : "")}>AUTO</div>
                            <div className={"rp-cell" + (match.red.gameStats.coralRP ? " win" : "")}>CORAL</div>
                            <div className={"rp-cell" + (match.red.gameStats.bargeRP ? " win" : "")}>BARGE</div>
                        ...
                        <div className="scores">
                            ...
                            <div className="row"><div className="label">BARGE</div><div className="score">{match.red.endgameScore}</div></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="alliance-match-result blue">
                    ...
                    <div className="rp-scores-row">
                        <div className="scores">
                            ...
                            <div className="row"><div className="score">{match.blue.endgameScore}</div><div className="label">BARGE</div></div>
                        </div>
                        <div className="rps">
                            <div className="total-rp">{match.blue.matchRP + match.blue.gameStats.autoRP + match.blue.gameStats.coralRP + match.blue.gameStats.bargeRP} RP</div>
                            <div className={"rp-cell" + (match.blue.gameStats.autoRP ? " win" : "")}>AUTO</div>
                            <div className={"rp-cell" + (match.blue.gameStats.coralRP ? " win" : "")}>CORAL</div>
                            <div className={"rp-cell" + (match.blue.gameStats.bargeRP ? " win" : "")}>BARGE</div>
