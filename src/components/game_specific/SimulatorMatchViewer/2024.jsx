            ...
            <div className="column">
                <div className="alliance-match-result red">
                    ...
                    <div className="rp-scores-row">
                        <div className="rps">
                            <div className="total-rp">{match.red.matchRP + (match.red.gameStats.melodyRP ? 1 : 0) + (match.red.gameStats.ensembleRP ? 1 : 0)} RP</div>
                            <div className={"rp-cell" + (match.red.gameStats.melodyRP ? " win" : "")}>MELODY</div>
                            <div className={"rp-cell" + (match.red.gameStats.ensembleRP ? " win" : "")}>ENSEMBLE</div>
                        ...
                        <div className="scores">
                            ...
                            <div className="row"><div className="label"># AMPED NOTES</div><div className="score">{match.red.gameStats.amplifiedNotes}</div></div>
                            <div className="row"><div className="label">STAGE</div><div className="score">{match.red.endgameScore}</div></div>
                            {/*<div className="row"><div className="label">CO-OPERTITION</div><div className="score">{match.red.gameStats.coopertitionPossible ? "✓" : "╳"}</div></div>*/}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="alliance-match-result blue">
                    ...
                    <div className="rp-scores-row">
                        <div className="scores">
                            ...
                            <div className="row"><div className="score">{match.blue.gameStats.amplifiedNotes}</div><div className="label"># AMPED NOTES</div></div>
                            <div className="row"><div className="score">{match.blue.endgameScore}</div><div className="label">STAGE</div></div>
                            {/* <div className="row"><div className="score">{match.blue.gameStats.coopertitionPossible ? "✓" : "╳"}</div><div className="label">CO-OPERTITION</div></div> */}
                        </div>
                        <div className="rps">
                            <div className="total-rp">{match.blue.matchRP + (match.blue.gameStats.melodyRP ? 1 : 0) + (match.blue.gameStats.ensembleRP ? 1 : 0)} RP</div>
                            <div className={"rp-cell" + (match.blue.gameStats.melodyRP ? " win" : "")}>MELODY</div>
                            <div className={"rp-cell" + (match.blue.gameStats.ensembleRP ? " win" : "")}>ENSEMBLE</div>
